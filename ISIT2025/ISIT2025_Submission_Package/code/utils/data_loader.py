...
class CompetitionDataLoader:
    ...
    def load_dataset(self, split: str):
        ...
        if split == 'train':
            file_pattern = os.path.join(self.data_dir, 'train_tfrecord', '*.tfrecords')
        elif split == 'val':
            file_pattern = os.path.join(self.data_dir, 'val_tfrecord', '*.tfrecords')
        else:  # test
            file_pattern = os.path.join(self.data_dir, 'test_tfrecord', '*.tfrecords')
